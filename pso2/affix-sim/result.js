...
PSO2.AbilityOption = {
	support: [
		...
		{name: 'Ability Success Rate +5%',  sname: '+5%',      value: 'A02', fn: function(v){ return Math.min(v +  5, 100); }},
		{name: 'Ability Success Rate +10%', sname: '+10%',     value: 'A03', fn: function(v){ return Math.min(v + 10, 100); }},
		{name: 'Ability Success Rate +20%', sname: '+20%',     value: 'A04', fn: function(v){ return Math.min(v + 20, 100); }},
		{name: 'Ability Success Rate +30%', sname: '+30%',     value: 'A05', fn: function(v){ return Math.min(v + 30, 100); }},
		{name: 'Ability Success Rate +40%', sname: '+40%',     value: 'A06', fn: function(v){ return Math.min(v + 40, 100); }}
	],
	additional: [
		...
		{name: 'Add Special Ability （HP&PP）',   value: 'B07', extend: 100, effect: 'HP(+50),PP(+3)'},
		{name: 'Add Special Ability （S-ATK&PP）', value: 'B08', extend: 100, effect: 'S-ATK(+30),PP(+3)'},
		{name: 'Add Special Ability （R-ATK&PP）', value: 'B09', extend: 100, effect: 'R-ATK(+30),PP(+3)'},
		{name: 'Add Special Ability （T-ATK&PP）', value: 'B10', extend: 100, effect: 'T-ATK(+30),PP(+3)'}
	]
};
